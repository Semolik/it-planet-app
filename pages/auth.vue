    ...
    <ion-content>
        <div class="wrapper">
            ...
            <div class="auth-frame">
                ...
                <auth-input class="auth-frame__input" v-model="login" placeholder="Логин" />
                <auth-input class="auth-frame__input" v-model="password" type="password" placeholder="Пароль" />
                <white-button :disabled="!isActive" class="auth-frame__submit-btn">Войти</white-button>
            </div>
            <div class="reg-offer">
...
const isActive = computed(() => password.value.length >= 8 && login.value.length > 0)
</script>

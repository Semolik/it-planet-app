    ...
    <ion-content class="content">
      <div class="wrapper">
        ...
        <div class="profile-inputs">
          ...
          <nuxt-link class="hobbies-container" to="/tabs/profile/hobbies">
            <div class="headline">
            ...
            <div class="hobbies">
              <hobbies-item v-for="hobby in hobbies" :hobby="hobby" />
            </div>
          </nuxt-link>
        </div>
      </div>
...
import { HobbiesService, UsersService } from "@/client";
